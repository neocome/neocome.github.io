...
!function (e) {
  ...
  function tt() {
    ...
    this.debugEnabled = function (t) {
      ...
      function o(e) {
        var t = n.window.console || {}, o = t[e] || t.log || h;
        e = !1;
        try {
          e = !!o.apply
        } catch (e) {
...
var mobile, Colors = {
  ...
  function e() {
    ...
    function r(e, t, n) {
      ...
      var r;
      if (e.length > 0 && (f.links[t].prev = e[0][0] - 1e3 * t), RTBTC.trigger("window.console", "Loaded " + e.length + " chart bars."), 0 != e.length) {
  ...
  function O() {
    ...
    try {
      ...
      DEBUG && yt("Could not clear user orders"), DEBUG && window.console.error(e)
    }
  }
  ...
  function ne() {
    if (!isNaN(parseInt(ce.w)) && (ce.w = 0 | ce.w, ce.w >= 0)) {
      try {
        ...
        try {
          "window.console" in window && window.console.log("Warning: " + ce.w)
        } catch (e) {
        }
      }
      i()
